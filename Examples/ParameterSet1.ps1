...
function Get-DiskSpaceInfo5 {
    <#
    This example is incomplete to execute, it show you parameter set setup on the parameter side
    Note: help file only appears if it loaded into a module
    #>
    ...
    param (
        ...
        [Parameter(Position=2,
                   #ParameterSetName="Info",  #comment this out make DriveType available to both parameter set i.e info and List
                   ValueFromPipelineByPropertyName=$true)]
