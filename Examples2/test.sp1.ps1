...
$CSV = "D:\Studying\PLURALSIGHT Courses\automation-powershell-scripts\05\demos\demos\diskhistory.csv"
...
foreach ($computer in $Computername) {
    ...
    Catch {Write-Warning "Failed to get disk data from $($computer.toUpper()). $($_.Exception.message)"
...
# .\GetDiskHistory.ps1 -Computername DOM1,FOO,Srv1,srv2
 .\test.sp1.ps1 -Computername DESKTOP-N5523PQ
