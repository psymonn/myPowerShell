...
function Write-PodcastXML()
{
  ...
  (
    ...
    [string] $XMLFilePath = 'F:\STUDYING\a PLURALSIGHT Courses\POWERSHELL\powershell-testing-pester\03\demos\Podcast-NoAgenda\OutputPathFolder\Podcast-Data\NoAgenda.xml'
  )
  begin 
  { 
