describe 'New-TestEnvironment' {
    ...
    $jsonPath = "F:\STUDYING\a PLURALSIGHT Courses\POWERSHELL\pester-infrastructure-testing\3-pester-infrastructure-testing-m3-exercise-files\Demos\9. Testing AutoUnattend Settings\ConfigurationItems.json"
