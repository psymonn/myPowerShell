describe 'New-TestEnvironment' {
    ...
    $jsonPath = "F:\STUDYING\a PLURALSIGHT Courses\POWERSHELL\pester-infrastructure-testing\3-pester-infrastructure-testing-m3-exercise-files\Demos\6. Building Infrastructure Tests\ConfigurationItems.json"
    ...
    context 'Virtual Machines' {
        ...
        $hyperVHostName = 'DESKTOP-N5523PQ'
