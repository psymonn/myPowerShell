describe 'New-TestEnvironment' {
    ...
    #$jsonPath = "F:\STUDYING\a PLURALSIGHT Courses\POWERSHELL\pester-infrastructure-testing\pester-infrastructure-testing-m4\Demos\8. Building Tests for AD Object Creation\ConfigurationItems.json"
    $jsonPath = "Z:\POWERSHELL\pester-infrastructure-testing\4-pester-infrastructure-testing-m4-exercise-files\Demos\8. Building Tests for AD Object Creation"
